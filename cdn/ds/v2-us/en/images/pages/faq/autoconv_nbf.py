# Originally written by pbsds:
# https://gist.github.com/pbsds/9c1c0fc417f49f7ef21d
# 
# Encoding function by James Daniel
#
# Kudos to http://stackoverflow.com/a/15595710 for RGB 555 encoding information
#
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "-d":
		if(len(sys.argv)==3):
			decode(sys.argv[2], sys.argv[2][:-3]+"nbf")
		else:
			decode(sys.argv[2], sys.argv[3])
    elif len(sys.argv) > 1 and sys.argv[1] == "-e":
		if(len(sys.argv)==3):
			encode(sys.argv[2], sys.argv[2][:-3]+"nbf")
		else:
